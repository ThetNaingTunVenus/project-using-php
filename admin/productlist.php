...
if (isset($_GET['action'])) {
	...
	if ($_GET['action'] == "cartorder") {
		...
		foreach ($_SESSION['cart'] as $key => $value) {
			...
			$insert_p = "INSERT INTO cart VALUES('','$name','$pid','$price','$qty','$pid')";
			$query = mysqli_query($con,$insert_p);
		}
		unset($_SESSION['cart']);
	}
		...
		<div class="min-height-200px">
			...
			<div class="col-md-12 col-sm-12 mb-30">
				<div class="pd-20 card-box height-100-p">
					...
					<!-- <h4 class="text-blue h4">New Item</h4> -->
					Add New Item
				...
				<div class="modal-dialog modal-dialog-centered">
					...
					<div class="modal-body">
						<div class="pd-20 card-box mb-30">
							...
							<div class="pb-20">					
								<form method="post" action="productlist.php" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							...
							Close
												...
												<input type="submit" name="insert" value="Save Item" class="btn btn-primary">
											</div>
										</div>
									</div>
								</div>
							...
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
									...
									while($row = mysqli_fetch_array($result)){?>
										<tr>
											<form method="post" action="productlist.php?id=<?= $row['id']; ?>">
												...
												<td><input type="submit" class="btn btn-sm btn-primary" name="add_cart" value="Add Cart"></td>
											</form>
						 ...
						 // var_dump($_SESSION['cart']);
									...
									if (!empty($_SESSION['cart'])) {
										...
										foreach ($_SESSION['cart'] as $key => $value) {
											...
											<td>
												<a href='productlist.php?action=remove&id=".$value['id']."'>
										...
										$output.="
											...
											<td>
												<a href='productlist.php?action=clearcart'>
												<button class='btn btn-sm btn-warning'>ClearCart</button>
												</a>
											</td>
											</tr>
											...
											<td colspan='5'></td>
											<td>
											<a href='productlist.php?action=cartorder'>
