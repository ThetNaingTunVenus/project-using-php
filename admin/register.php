...
if (isset($_POST['insert'])) {
	...
	$inser_query = "INSERT INTO user VALUES ('','$name', '$pass','')";
	$query = mysqli_query($con,$inser_query);
	echo "<script>alert('User has been successfully inserted into the database.')</script>";
		...
		<div class="min-height-200px">
			...
			<div class="col-md-12 col-sm-12 mb-30">
				<div class="pd-20 card-box height-100-p">
					...
					<h4 class="text-white h4">+ New User</h4>
